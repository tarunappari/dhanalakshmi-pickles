...
import {
  getStaticProductHandles,
  getStaticProductByHandle,
} from "@/data/products";
...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    return {
      ...
      description:
        product.description ||
        `View details for ${product.title} in our plant collection.`,
      openGraph: {
        title: product.title,
    ...
    return {
      ...
      description: `View details for ${handle.replace(
        /-/g,
        " "
      )} in our plant collection.`,
    };
  }
}
